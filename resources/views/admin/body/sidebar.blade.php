    ...
    <div class="h-100" data-simplebar>
        ...
        <div id="sidebar-menu">
            ...
            <ul id="side-menu">
                ...
                <li>
                    <a href="#UsabilityData" data-bs-toggle="collapse">
                        <i data-feather="alert-octagon"></i>
                        <span> Usability Data Setup </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="UsabilityData">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('all.connect') }}" class="tp-link">All Usability Data</a>
                            </li>
                            <li>
                                <a href="{{ route('add.connect') }}" class="tp-link">Add Usability Data</a>
                            </li>
                        </ul>
                    </div>
                </li>
