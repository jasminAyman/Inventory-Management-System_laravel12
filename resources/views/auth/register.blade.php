                            ...
                            <div class="pt-0">
                                <form method="POST" action="{{ route('register') }}" class="my-4">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="password" id="password" name="password" required="" placeholder="Enter your email">
                                    </div>
                                ...
                                <div class="saprator my-4"><span>or sign in with</span></div>
                                    ...
                                    <div class="text-center text-muted mb-4">
                                        <p class="mb-0">Want to login ?
                                            <a class='text-primary ms-2 fw-medium' href='{{ route('login') }}'>Sing In</a></p>
                                    </div>
